...
// 11 File Template
var template_11_file_usb='/template_11.bin';
var template_11_file_blind='/dev_hdd0/tmp/template_11.bin';
var template_11_file_buf_addr=0x8B000000;
var template_11_file_usb_addr=0;
var template_11_file_usbfd_addr=0;
var template_11_file_usb_readlen_addr=0;
var template_11_file_blind_addr=0;
var template_11_file_blindfd_addr=0;
var template_11_file_blind_writelen_addr=0;

// 12 File Template
var template_12_file_usb='/template_12.bin';
var template_12_file_blind='/dev_hdd0/tmp/template_12.bin';
var template_12_file_buf_addr=0x8B000000;
var template_12_file_usb_addr=0;
var template_12_file_usbfd_addr=0;
var template_12_file_usb_readlen_addr=0;
var template_12_file_blind_addr=0;
var template_12_file_blindfd_addr=0;
var template_12_file_blind_writelen_addr=0;

// 13 File Template
var template_13_file_usb='/template_13.bin';
var template_13_file_blind='/dev_hdd0/tmp/template_13.bin';
var template_13_file_buf_addr=0x8B000000;
var template_13_file_usb_addr=0;
var template_13_file_usbfd_addr=0;
var template_13_file_usb_readlen_addr=0;
var template_13_file_blind_addr=0;
var template_13_file_blindfd_addr=0;
var template_13_file_blind_writelen_addr=0;

// 14 File Template
var template_14_file_usb='/template_14.bin';
var template_14_file_blind='/dev_hdd0/tmp/template_14.bin';
var template_14_file_buf_addr=0x8B000000;
var template_14_file_usb_addr=0;
var template_14_file_usbfd_addr=0;
var template_14_file_usb_readlen_addr=0;
var template_14_file_blind_addr=0;
var template_14_file_blindfd_addr=0;
var template_14_file_blind_writelen_addr=0;

// 15 File Template
var template_15_file_usb='/template_15.bin';
var template_15_file_blind='/dev_hdd0/tmp/template_15.bin';
var template_15_file_buf_addr=0x8B000000;
var template_15_file_usb_addr=0;
var template_15_file_usbfd_addr=0;
var template_15_file_usb_readlen_addr=0;
var template_15_file_blind_addr=0;
var template_15_file_blindfd_addr=0;
var template_15_file_blind_writelen_addr=0;

// 16 File Template
var template_16_file_usb='/template_16.bin';
var template_16_file_blind='/dev_hdd0/tmp/template_16.bin';
var template_16_file_buf_addr=0x8B000000;
var template_16_file_usb_addr=0;
var template_16_file_usbfd_addr=0;
var template_16_file_usb_readlen_addr=0;
var template_16_file_blind_addr=0;
var template_16_file_blindfd_addr=0;
var template_16_file_blind_writelen_addr=0;

// 17 File Template
var template_17_file_usb='/template_17.bin';
var template_17_file_blind='/dev_hdd0/tmp/template_17.bin';
var template_17_file_buf_addr=0x8B000000;
var template_17_file_usb_addr=0;
var template_17_file_usbfd_addr=0;
var template_17_file_usb_readlen_addr=0;
var template_17_file_blind_addr=0;
var template_17_file_blindfd_addr=0;
var template_17_file_blind_writelen_addr=0;

// 18 File Template
var template_18_file_usb='/template_18.bin';
var template_18_file_blind='/dev_hdd0/tmp/template_18.bin';
var template_18_file_buf_addr=0x8B000000;
var template_18_file_usb_addr=0;
var template_18_file_usbfd_addr=0;
var template_18_file_usb_readlen_addr=0;
var template_18_file_blind_addr=0;
var template_18_file_blindfd_addr=0;
var template_18_file_blind_writelen_addr=0;

// 19 File Template
var template_19_file_usb='/template_19.bin';
var template_19_file_blind='/dev_hdd0/tmp/template_19.bin';
var template_19_file_buf_addr=0x8B000000;
var template_19_file_usb_addr=0;
var template_19_file_usbfd_addr=0;
var template_19_file_usb_readlen_addr=0;
var template_19_file_blind_addr=0;
var template_19_file_blindfd_addr=0;
var template_19_file_blind_writelen_addr=0;

// 20 File Template
var template_20_file_usb='/template_20.bin';
var template_20_file_blind='/dev_hdd0/tmp/template_20.bin';
var template_20_file_buf_addr=0x8B000000;
var template_20_file_usb_addr=0;
var template_20_file_usbfd_addr=0;
var template_20_file_usb_readlen_addr=0;
var template_20_file_blind_addr=0;
var template_20_file_blindfd_addr=0;
var template_20_file_blind_writelen_addr=0;
...
//####################################################################################################################################################################
function rop_exit_20val(suc,fail,fail1,fail2,fail3,fail4,fail5,fail6,fail7,fail8,fail9,fail10,fail11,fail12,fail13,fail14,fail15,fail16,fail17,fail18,fail19,fail20)
{
	...
	var t_val11=xtra_data.substr(store_idx_arr1[10],2).toAscii(true);
	var t_val12=xtra_data.substr(store_idx_arr1[11],2).toAscii(true);
	var t_val13=xtra_data.substr(store_idx_arr1[12],2).toAscii(true);
	var t_val14=xtra_data.substr(store_idx_arr1[13],2).toAscii(true);
	var t_val15=xtra_data.substr(store_idx_arr1[14],2).toAscii(true);
	var t_val16=xtra_data.substr(store_idx_arr1[15],2).toAscii(true);
	var t_val17=xtra_data.substr(store_idx_arr1[16],2).toAscii(true);
	var t_val18=xtra_data.substr(store_idx_arr1[17],2).toAscii(true);
	var t_val19=xtra_data.substr(store_idx_arr1[18],2).toAscii(true);
	var t_val20=xtra_data.substr(store_idx_arr1[19],2).toAscii(true);
	
	var t_val21=xtra_data.substr(store_idx_arr2[0],2).toAscii(true);
	var t_val22=xtra_data.substr(store_idx_arr2[1],2).toAscii(true);
	var t_val23=xtra_data.substr(store_idx_arr2[2],2).toAscii(true);
	var t_val24=xtra_data.substr(store_idx_arr2[3],2).toAscii(true);
	var t_val25=xtra_data.substr(store_idx_arr2[4],2).toAscii(true);
	var t_val26=xtra_data.substr(store_idx_arr2[5],2).toAscii(true);
	var t_val27=xtra_data.substr(store_idx_arr2[6],2).toAscii(true);
	var t_val28=xtra_data.substr(store_idx_arr2[7],2).toAscii(true);
	var t_val29=xtra_data.substr(store_idx_arr2[8],2).toAscii(true);
	var t_val30=xtra_data.substr(store_idx_arr2[9],2).toAscii(true);
	var t_val31=xtra_data.substr(store_idx_arr2[10],2).toAscii(true);
	var t_val32=xtra_data.substr(store_idx_arr2[11],2).toAscii(true);
	var t_val33=xtra_data.substr(store_idx_arr2[12],2).toAscii(true);
	var t_val34=xtra_data.substr(store_idx_arr2[13],2).toAscii(true);
	var t_val35=xtra_data.substr(store_idx_arr2[14],2).toAscii(true);
	var t_val36=xtra_data.substr(store_idx_arr2[15],2).toAscii(true);
	var t_val37=xtra_data.substr(store_idx_arr2[16],2).toAscii(true);
	var t_val38=xtra_data.substr(store_idx_arr2[17],2).toAscii(true);
	var t_val39=xtra_data.substr(store_idx_arr2[18],2).toAscii(true);
	var t_val40=xtra_data.substr(store_idx_arr2[19],2).toAscii(true);
	...
	(parseInt(t_val11,16)!==0)&&
	(parseInt(t_val12,16)!==0)&&
	(parseInt(t_val13,16)!==0)&&
	(parseInt(t_val14,16)!==0)&&
	(parseInt(t_val15,16)!==0)&&
	(parseInt(t_val16,16)!==0)&&
	(parseInt(t_val17,16)!==0)&&
	(parseInt(t_val18,16)!==0)&&
	(parseInt(t_val19,16)!==0)&&
	(parseInt(t_val20,16)!==0)&&
	
	(parseInt(t_val1,16)===(parseInt(t_val21,16)))&&
	(parseInt(t_val2,16)===(parseInt(t_val22,16)))&&
	(parseInt(t_val3,16)===(parseInt(t_val23,16)))&&
	(parseInt(t_val4,16)===(parseInt(t_val24,16)))&&
	(parseInt(t_val5,16)===(parseInt(t_val25,16)))&&
	(parseInt(t_val6,16)===(parseInt(t_val26,16)))&&
	(parseInt(t_val7,16)===(parseInt(t_val27,16)))&&
	(parseInt(t_val8,16)===(parseInt(t_val28,16)))&&
	(parseInt(t_val9,16)===(parseInt(t_val29,16)))&&
	(parseInt(t_val10,16)===(parseInt(t_val30,16)))
	(parseInt(t_val11,16)===(parseInt(t_val31,16)))&&
	(parseInt(t_val12,16)===(parseInt(t_val32,16)))&&
	(parseInt(t_val13,16)===(parseInt(t_val33,16)))&&
	(parseInt(t_val14,16)===(parseInt(t_val34,16)))&&
	(parseInt(t_val15,16)===(parseInt(t_val35,16)))&&
	(parseInt(t_val16,16)===(parseInt(t_val36,16)))&&
	(parseInt(t_val17,16)===(parseInt(t_val37,16)))&&
	(parseInt(t_val18,16)===(parseInt(t_val38,16)))&&
	(parseInt(t_val19,16)===(parseInt(t_val39,16)))&&
	(parseInt(t_val20,16)===(parseInt(t_val40,16)))
	)
	{
	...
	{
		if((parseInt(t_val1,16)!==parseInt(t_val21,16))||(parseInt(t_val1,16)===0))fail+=fail1;
		if((parseInt(t_val2,16)!==parseInt(t_val22,16))||(parseInt(t_val2,16)===0))fail+=fail2;
		if((parseInt(t_val3,16)!==parseInt(t_val23,16))||(parseInt(t_val3,16)===0))fail+=fail3;
		if((parseInt(t_val4,16)!==parseInt(t_val24,16))||(parseInt(t_val4,16)===0))fail+=fail4;
		if((parseInt(t_val5,16)!==parseInt(t_val25,16))||(parseInt(t_val5,16)===0))fail+=fail5;
		if((parseInt(t_val6,16)!==parseInt(t_val26,16))||(parseInt(t_val6,16)===0))fail+=fail6;
		if((parseInt(t_val7,16)!==parseInt(t_val27,16))||(parseInt(t_val7,16)===0))fail+=fail7;
		if((parseInt(t_val8,16)!==parseInt(t_val28,16))||(parseInt(t_val8,16)===0))fail+=fail8;
		if((parseInt(t_val9,16)!==parseInt(t_val29,16))||(parseInt(t_val9,16)===0))fail+=fail9;
		if((parseInt(t_val10,16)!==parseInt(t_val30,16))||(parseInt(t_val10,16)===0))fail+=fail10;
		if((parseInt(t_val11,16)!==parseInt(t_val31,16))||(parseInt(t_val11,16)===0))fail+=fail11;
		if((parseInt(t_val12,16)!==parseInt(t_val32,16))||(parseInt(t_val12,16)===0))fail+=fail12;
		if((parseInt(t_val13,16)!==parseInt(t_val33,16))||(parseInt(t_val13,16)===0))fail+=fail13;
		if((parseInt(t_val14,16)!==parseInt(t_val34,16))||(parseInt(t_val14,16)===0))fail+=fail14;
		if((parseInt(t_val15,16)!==parseInt(t_val35,16))||(parseInt(t_val15,16)===0))fail+=fail15;
		if((parseInt(t_val16,16)!==parseInt(t_val36,16))||(parseInt(t_val16,16)===0))fail+=fail16;
		if((parseInt(t_val17,16)!==parseInt(t_val37,16))||(parseInt(t_val17,16)===0))fail+=fail17;
		if((parseInt(t_val18,16)!==parseInt(t_val38,16))||(parseInt(t_val18,16)===0))fail+=fail18;
		if((parseInt(t_val19,16)!==parseInt(t_val39,16))||(parseInt(t_val19,16)===0))fail+=fail19;
		if((parseInt(t_val20,16)!==parseInt(t_val40,16))||(parseInt(t_va20,16)===0))fail+=fail20;
		tmp=fail;
	}
	showResult(tmp);
}
...
function optional_reboot20(newframe,addr1,addr2,addr3,addr4,addr5,addr6,addr7,addr8,addr9,addr10,addr11,addr12,addr13,addr14,addr15,addr16,addr17,addr18,addr19,addr20)
{
	var auto=document.getElementById('auto_reboot');
	if(auto){if(auto.checked===true)return validate_word_from_ptr(addr1+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr2+0x4,newframe+0x10,gadget_mod8_addr)
	...
	+validate_word_from_ptr(addr9+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr10+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr11+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr12+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr13+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr14+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr15+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr16+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr17+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr18+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr19+0x4,newframe+0x10,gadget_mod8_addr)
	+validate_word_from_ptr(addr20+0x4,newframe+0x10,gadget_mod8_addr)
	+stack_frame_swap(newframe);}
	return '';
}
